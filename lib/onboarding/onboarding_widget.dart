                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Save over 40% on delivery costs when you pay by mileage, monthly.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2
                                                .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Need to deliver anything? Just book a delivery without having to worry about the cost of delivery.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2
                                                .override(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'ONBOARDING_COMPLETE_SIGN_UP_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_Request-Permissions');
                                              await requestPermission(
                                                  photoLibraryPermission);
                                              logFirebaseEvent(
                                                  'Button_Request-Permissions');
                                              await requestPermission(
                                                  accessMediaLocationPermission);
                                              logFirebaseEvent(
                                                  'Button_Request-Permissions');
                                              await requestPermission(
                                                  cameraPermission);
