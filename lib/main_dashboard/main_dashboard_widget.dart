                ...
                children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'MAIN_DASHBOARD_PAGE_Row_irehonb1_ON_TAP');
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MAIN_DASHBOARD_PAGE_Card_rwhgd886_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'MAIN_DASHBOARD_PAGE_Row_5wvzth2l_ON_TAP');
                              logFirebaseEvent('Row_Navigate-To');
                              await Navigator.push(
                                context,
                                PageTransition(
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'MAIN_DASHBOARD_PAGE_Row_p25y1tzc_ON_TAP');
                              logFirebaseEvent('Row_Navigate-To');
                              await Navigator.push(
                                context,
                                PageTransition(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        logFirebaseEvent(
                            'MAIN_DASHBOARD_ListTile_ktm142u3_ON_TAP');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'MAIN_DASHBOARD_ListTile_v9jkzym5_ON_TAP');
                      logFirebaseEvent('ListTile_Navigate-To');
                      await Navigator.push(
                        context,
                        PageTransition(
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'MAIN_DASHBOARD_ListTile_kpsjxfik_ON_TAP');
                      logFirebaseEvent('ListTile_Navigate-To');
                      await Navigator.push(
                        context,
                        PageTransition(
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'MAIN_DASHBOARD_ListTile_z6ks1123_ON_TAP');
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'MAIN_DASHBOARD_ListTile_z6u9vaxr_ON_TAP');
                              logFirebaseEvent('ListTile_Launch-U-R-L');
                              await launchURL('tel:09125438113');
                            },
                            child: ListTile(
                              title: Text(
                                'Call  0912-543-8113',
