                          ...
                          if (valueOrDefault(
                            ...
                            if (FFAppState().mileageCost == 0.0) {
                              ...
                              if (confirmDialogResponse) {
                                ...
                                setState(() => FFAppState().mileageCost = 0.0);
                                logFirebaseEvent(
                                    'PlaceBookingButton_Trigger-Push-Notifica');
                                triggerPushNotification(
                                  notificationTitle:
                                      'Delivery Booking Placed Successfully',
                                  notificationText:
                                      'A rider will be in touch with you shortly to make your delivery.',
                                  notificationSound: 'default',
                                  userRefs: [currentUserReference!],
                                  initialPageName: 'deliveryOrderList',
                                  parameterData: {},
                                );
                                logFirebaseEvent(
