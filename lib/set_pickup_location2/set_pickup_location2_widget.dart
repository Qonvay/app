...
class SetPickupLocation2Widget extends StatefulWidget {
  const SetPickupLocation2Widget({
    Key key,
  ...
  @override
  _SetPickupLocation2WidgetState createState() =>
      _SetPickupLocation2WidgetState();
}

class _SetPickupLocation2WidgetState extends State<SetPickupLocation2Widget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TransactionsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final setPickupLocation2TransactionsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
