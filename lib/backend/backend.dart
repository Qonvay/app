...
Stream<List<BookOrderRecord>> queryBookOrderRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(BookOrderRecord.collection, BookOrderRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<BookOrderRecord>> queryBookOrderRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(BookOrderRecord.collection, BookOrderRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Stream<List<OrderTrackingRecord>> queryOrderTrackingRecord(
        ...
        bool singleRecord = false}) =>
    queryCollection(
        OrderTrackingRecord.collection, OrderTrackingRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
